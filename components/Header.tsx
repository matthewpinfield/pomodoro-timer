...
import { Settings, PieChart, Clock, AlertCircle, Info, Coffee, AlarmClock, User, CalendarDays } from "lucide-react";
...
export function Header() {
  ...
  const menuItems = [
    ...
    {
      name: "Calendar",
      icon: <CalendarDays className="w-icon-base h-icon-base" />,
      onClick: () => { router.push("/calendar"); setIsMenuOpen(false); },
    },
    {
      name: "Account",
