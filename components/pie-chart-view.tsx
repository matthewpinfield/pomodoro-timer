  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-0 sm:px-4 flex flex-col h-full">
      ...
      <div className="flex flex-col md:flex-row md:items-start gap-6 sm:gap-8 md:gap-12 relative flex-1">
         ...
         <div className="w-full md:w-7/12 lg:w-[55%] flex flex-col relative overflow-hidden glass-card rounded-[2rem] sm:rounded-[2.5rem] p-5 sm:p-8 xl:p-10 mb-4 flex-1 md:sticky md:self-start md:top-0 md:max-h-[calc(100vh-8rem)]">
